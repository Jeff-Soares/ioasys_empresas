...
class LocalDataSourceImpl(
    ...
    override fun getHeadersFromPreferences(): Headers {
    ...
    override suspend fun saveFavoritesToLocalDatabase(company: Company) {
        companyDao.saveCompany(company.toLocalModel())
    }

    override suspend fun removeFavoritesFromLocalDatabase(company: Company) {
        companyDao.removeCompany(company.toLocalModel())
    }

    override suspend fun getFavoritesFromLocalDatabase(): List<Company> {
